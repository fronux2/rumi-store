      ...
      <Swiper loop={true} navigation={true} autoplay={{ delay: 5600, disableOnInteraction: false }} modules={[Navigation, Autoplay]} className="mySwiper">
            ...
            <SwiperSlide>
                <div className='flex flex-col sm:flex-row relative w-full bg-slate-200' >
                    ...
                    <Image src={img12} alt='' className=' absolute top-[50%] left-[40%] translateImg' width={600} height={600}/>
                </div>
            </SwiperSlide>
            <SwiperSlide>
                <div className='flex flex-col sm:flex-row relative w-full bg-slate-200' >
                    ...
                    <Image src={img22} alt='' className='absolute top-[50%] left-[40%] translateImg' width={600} height={600}/>
                </div>
            </SwiperSlide>
            <SwiperSlide>
                <div className='flex flex-col sm:flex-row relative w-full bg-slate-200' >
                    ...
                    <Image src={img32} alt='' className=' absolute top-[50%] left-[40%] translateImg' width={600} height={600}/>
                </div>
            </SwiperSlide>
