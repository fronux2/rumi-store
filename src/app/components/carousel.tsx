      ...
      <Swiper loop={true} navigation={true} autoplay={{ delay: 5600, disableOnInteraction: false }} modules={[Navigation, Autoplay]} className="mySwiper">
            ...
            <SwiperSlide>
                <div className='flex flex-col sm:flex-row relative w-full bg-slate-200' >
                    ...
                    <div className='container-car lg:pt-56'>
                        <h1 className='font-bold text-4xl font-pacifico'>El Sabor de Nuestro Hogar</h1>
            ...
            <SwiperSlide>
                <div className='flex flex-col sm:flex-row relative w-full bg-slate-200' >
                    ...
                    <div className='container-car lg:pt-56'>
                        <h1 className='font-bold text-4xl font-pacifico'>Mira nuestra serie</h1>
            ...
            <SwiperSlide>
                <div className='flex flex-col sm:flex-row relative w-full bg-slate-200' >
                    ...
                    <div className='container-car lg:pt-56'>
                        <h1 className='font-bold  text-4xl font-pacifico'>Lobos Selecciones</h1>
