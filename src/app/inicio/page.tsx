...
export default function PageIndex () {
  return (
    <section className='bg-white'>
      ...
      <section className='flex md:pl-72 md:pr-72 overflow-x-auto relative bg-slte-100 px-5 py-10 md:px-24 md:py-5  gap-3 bg-slate-100'>
      ...
      <section className='flex md:pl-72 md:pr-72 md:grid overflow-x-auto gap-2 px-5 py-10 md:px-24 md:py-10 grid-cols-12 md:grid-cols-3 h-auto w-full bg-slate-200'>
        <CardStore2/>
        <CardStore2/>
        <CardStore2/>
        <CardStore2/>
